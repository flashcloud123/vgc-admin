				              ...
				              <tbody>
				               ...
				               <?php  if(isset($faqs)): ?>
				                ...
				                <tr class="row_<?php echo $banner->id; ?>" >
				                  ...
				                  <td>
				                  	<a href="<?php echo base_url('dashboard/edit_token_info/'.$banner->id); ?>" class="btn btn-primary"> Edit</a> |
				                  	<a href="javascript:void(0);" class="btn btn-danger delete" data-id='<?php echo $banner->id; ?>' data-table='token_info' data-type='banner_section'>  Delete</a>
				                  </td>
